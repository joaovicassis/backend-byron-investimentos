...
import { BuscarInvestimentoRequest } from '../../interfaces/investimentos/BuscarInvestimentoRequest';
...
export class BuscarInvestimentoService {
  async execute({ id }: BuscarInvestimentoRequest, userId: string): Promise<InvestimentoResponse> {
